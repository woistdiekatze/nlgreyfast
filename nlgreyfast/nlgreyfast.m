function estmodel = nlgreyfast(data, model, fopts)
    ...
    [estmodel.param_est_v, estmodel.x0_est_v, estmodel.diag_data ] = nlidcomb( ...
        plant_next, ...
        fs, ...
        u_data_V, ...
        y_data_V, ...
        ...
        fopts.X_guess_H, ...
        fopts.ubx_X_guess_H, ...
        fopts.additional_constraints_lbg_v, ...
        fopts.additional_constraints_g, ...
        fopts.additional_constraints_ubg_v, ...
        fopts.enable_gaps_v, ...
        fopts ...
    );
